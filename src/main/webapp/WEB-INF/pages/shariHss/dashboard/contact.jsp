...
<section id="contact" class="contact">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" id="feed_back">
                <form action="#" method="post" role="form" id="feedback" class="php-email-form">
                    ...
                    <div class="text-center">
                        <button type="button" class="btn text-white" id="btnSend" style="background-color: #d0802b">Send</button>
                    </div>
                </form>
            </div>
        </div>
