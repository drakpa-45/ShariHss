    ...
    public final List<JasperPrint> getJasperPrintForExporting(
        ...
        String generatedDate = currentDate.format(DateTimeFormatter.ofPattern("dd-MM-yyyy"));
            try {
              ...
              // connection= DriverManager.getConnection("jdbc:mysql://localhost:3306/paroHss","root","root");
                connection= DriverManager.getConnection("jdbc:mysql://172.30.79.17:3306/paroHss","dofps_usr","dofpsUser@2023#");
