...
import bt.gov.ditt.paroHss.dto.*;
...
public class DaoRuralTimber extends BaseDao implements IDaoRuralTimber {
    ...
    public long getTempNo() {
        ...
        try {
          // String QUE = properties.getProperty("CommonDao.draft");
            ...
            org.hibernate.query.Query query = sqlQuery1(QUE);
            ...
            if (seqNo <= 1) {
               //String insert = properties.getProperty("CommonDao.draftInsert");
                ...
                org.hibernate.query.Query query1 = sqlQuery1(insert);
               ...
               // String update = properties.getProperty("CommonDao.draftUpdate");
                ...
                org.hibernate.query.Query query1 = sqlQuery1(update);
                query1.setParameter("SeqNo", seqNo);
                query1.setParameter("type", "Draft");
                query1.executeUpdate();
            }
    ...
    public NewTimberDto saveUpdateApplication(CitizenDetailsDTO dto, NewTimberDto newTimberDto, String appNo, String draftNo) {
        ...
        try {
            org.hibernate.query.Query query1 = sqlQuery("UPDATE t_fp_application SET Application_Number =?, Geog_No=?,Cons_Loc_Village_Serial_No=?,Construction_Location=?,App_Submission_Date=CURRENT_DATE WHERE Application_Number =?", NewTimberDto.class);
            ...
            if(save > 0){
                org.hibernate.query.Query query2 = sqlQuery("UPDATE t_fp_appl_allotment SET Application_Number =? WHERE Application_Number =?", NewTimberDto.class);
    ...
    public BigInteger validatePreviousApp(claimAdditionalTimberDTO claimAdditionalTimberDTO) {
        ...
        try{
            String sqlQuery = "SELECT \n" +
                    ...
                    "  )\n" +
                    "AND w.Status_Id <> 7";
            org.hibernate.query.Query hQuery = (org.hibernate.query.Query) hibernateQuery(sqlQuery).setParameter(1, cid_number);
    ...
    public BigInteger CountExit(CitizenDetailsDTO dto, NewTimberDto newTimberDto, HttpServletRequest request, String cons_type) {
       String sqlQuery="";
        try {
            ...
            org.hibernate.query.Query hQuery = (org.hibernate.query.Query) hibernateQuery(sqlQuery).setParameter(1, dto.getHouse_Hold_No())
