...
import bt.gov.ditt.paroHss.entitiy.*;
...
public class DaoCommon extends BaseDao implements IDaoCommon {
    ...
    public String forwardToOtherRange(String appNo, String remarks, int rangeId) {
        ...
        String update_wrkflow = "UPDATE t_fp_application SET Allot_Range_Officer=? WHERE Application_Number=?";
        Query query1 = (Query) hibernateQuery(update_wrkflow).setParameter(1, rangeId).setParameter(2, appNo);
        save = query1.executeUpdate();
        if (save > 0) {
            applicationstatus="Success";
        }else{
    ...
    public BigInteger checkForValidation(String house_hold, String cons_type) {
        ...
        try {
            ...
            org.hibernate.query.Query hQuery = (org.hibernate.query.Query) hibernateQuery(sqlQuery).setParameter(1, house_hold).setParameter(2, cons_type);
    ...
    public BigInteger CountDuration(String cid, String type) {
        try{
            ...
            org.hibernate.query.Query hQuery = (org.hibernate.query.Query) hibernateQuery(sqlQuery).setParameter(1, cid);
            return (BigInteger) hQuery.uniqueResult();
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    public BigInteger CountExit(WorkFlowDto dto) {
        try{
            ...
            org.hibernate.query.Query hQuery = (org.hibernate.query.Query) hibernateQuery(sqlQuery).setParameter(1, dto.getApplication_Number());
            return (BigInteger) hQuery.uniqueResult();
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public BigInteger getYearValidation(String sl_no, String house_no) {
        ...
        try{
            if(sl_no.equalsIgnoreCase("6") || sl_no.equalsIgnoreCase("7")){
                ...
                org.hibernate.query.Query hQuery = (org.hibernate.query.Query) hibernateQuery(sqlQuery)
