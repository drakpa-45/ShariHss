...
import bt.gov.ditt.paroHss.base.BaseDao;
...
public class DaoCFO extends BaseDao implements IDaoCFO {
    ...
    public WorkFlowDto updateAppAudit(WorkFlowDto workFlowDto, HttpServletRequest request) {
        ...
        try {
            ...
            if (userRolePriv.getUserRoles().getUserRole().get(0).getRoleName() != null && request.getParameter("value")!=null) {
                ...
                org.hibernate.Query hQuery1 = hibernateQuery(sqlQuery, WorkFlowDto.class).setParameter(1,appdto.getAllot_Range_Officer()).setParameter(2, request.getParameter("value"));
    ...
    public WorkFlowDto updateTdskAudit(WorkFlowDto workFlowDto, HttpServletRequest request, String roleId, String role_name) {
        ...
        try {
            ...
            if (userRolePriv.getUserRoles().getUserRole().get(0).getRoleName() != null && request.getParameter("value")!=null) {
                ...
                org.hibernate.Query hQuery1 = hibernateQuery(sqlQuery, WorkFlowDto.class).setParameter(1,wrk.get(0).getAssigned_User_Id()).setParameter(2, "5")
    ...
    public WorkFlowDto updateWrkAudit(WorkFlowDto workFlowDto, HttpServletRequest request, String roleId, String role_name) {
        ...
        try {
            ...
            if (userRolePriv.getUserRoles().getUserRole().get(0).getRoleName() != null && request.getParameter("value")!=null) {
                ...
                org.hibernate.Query hQuery1 = hibernateQuery(sqlQuery, WorkFlowDto.class).setParameter(1,wrk.get(0).getActor_Name()).setParameter(2,wrk.get(0).getStatus_Id())
    ...
    public WorkFlowDto upadteClaimedApp(WorkFlowDto workFlowDto, HttpServletRequest request, String roleId, String role_name) {
        ...
        try {
            if (userRolePriv.getUserRoles().getUserRole().get(0).getRoleName() != null) {
                ...
                org.hibernate.Query hQuery = hibernateQuery(sqlQuery, WorkFlowDto.class).setParameter(1, workFlowDto.getApproval_Remarks()).setParameter(2, request.getParameter("value"));
    ...
    public WorkFlowDto updateAllot(WorkFlowDto workFlowDto, WorkFlowDto workFlow, HttpServletRequest request) {
        ...
        try {
            if (userRolePriv.getUserRoles().getUserRole().get(0).getRoleName() != null) {
                ...
                org.hibernate.Query hQuery = hibernateQuery(sqlQuery, WorkFlowDto.class).setParameter(1, workFlow.getAllot_Quantity()).setParameter(2, workFlow.getNet_Royalty()).setParameter(3,workFlow.getTotal_Royalty()).setParameter(4, workFlow.getApproval_Remarks())
    ...
    public WorkFlowDto updateAllotment(WorkFlowDto workFlowDto, WorkFlowDto workFlow, HttpServletRequest request) {
        ...
        try {
            if (userRolePriv.getUserRoles().getUserRole().get(0).getRoleName() != null) {
                String sqlQuery = "UPDATE t_fp_appl_allotment SET Allot_Quantity = ?, Net_Royalty = ?, Total_Royalty = ?,App_Approval_Date = CURRENT_DATE, Approval_Remarks=?\n" +
                        "WHERE `Application_Number`=? AND FP_Product_Id=?";
                org.hibernate.Query hQuery = hibernateQuery(sqlQuery, WorkFlowDto.class).setParameter(1, workFlow.getAllot_Quantity_log()).setParameter(2, "10").setParameter(3,"10").setParameter(4, workFlow.getApproval_Remarks())
                        .setParameter(5, request.getParameter("value")).setParameter(6, workFlowDto.getFp_Product_Id());
                int save = hQuery.executeUpdate();
                if(save>0){
                    workFlowDto.setCurrent_Status("success");
    ...
    public WorkFlowDto updateAllotWP(WorkFlowDto workFlowDto, WorkFlowDto workFlow, HttpServletRequest request) {
        ...
        try {
            if (userRolePriv.getUserRoles().getUserRole().get(0).getRoleName() != null) {
                String sqlQuery = "UPDATE t_fp_appl_allotment SET Allot_Quantity = ?, Net_Royalty = ?, Total_Royalty = ?,App_Approval_Date = CURRENT_DATE, Approval_Remarks=?\n" +
                        "WHERE `Application_Number`=? AND FP_Product_Id=?";
                org.hibernate.Query hQuery = hibernateQuery(sqlQuery, WorkFlowDto.class).setParameter(1, workFlowDto.getAllot_Quantity()).setParameter(2, workFlowDto.getTotal_Royalty()).setParameter(3,workFlow.getTotal_Royalty()).setParameter(4, workFlow.getApproval_Remarks())
                        .setParameter(5, request.getParameter("value")).setParameter(6, workFlowDto.getFp_Product_Id());
                int save = hQuery.executeUpdate();
                if(save>0){
                    workFlowDto.setCurrent_Status("success");
    ...
    if (userRolePriv.getUserRoles().getUserRole().get(0).getRoleName() != null) {
        ...
        org.hibernate.Query hQuery = hibernateQuery(sqlQuery, WorkFlowDto.class).setParameter(1, userRolePriv.getFullName()).setParameter(2, "3")
