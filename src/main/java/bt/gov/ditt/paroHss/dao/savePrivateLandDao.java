    ...
    public String updatePrivateProduceDetailsByRO(String appNo, HttpServletRequest request, WorkFlowDto workFlowDto) {
        ...
        try {
            if (userRolePriv.getUserRoles().getUserRole().get(0).getRoleName() != null) {
                ...
                org.hibernate.Query hQuery = hibernateQuery(sqlQuery, WorkFlowDto.class).setParameter(1, workFlowDto.getPlot_No()).setParameter(2, workFlowDto.getGps_Coordinates())
                        .setParameter(3, workFlowDto.getLand_Category()).setParameter(4, workFlowDto.getAcres()).setParameter(5, workFlowDto.getPeg_No()).setParameter(6, workFlowDto.getLandAdjoining()).setParameter(7, appNo);
